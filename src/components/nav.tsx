...
const Nav = () => {
  return (
    <div className='fixed top-10 left-0 right-0 z-50 flex justify-center px-4'>
      <div className='flex justify-between items-center gap-10 bg-transparent backdrop-blur-3xl text-white border border-[#242938] px-2 h-[60px] rounded-2xl w-full max-w-4xl'>
